...
class Ownersproperties(models.Model):
    ...
    group_uid = models.BigIntegerField(blank=True, null=True)
    propertysituationid = models.ForeignKey(Parcels, db_column='propertysituationid', on_delete=models.CASCADE, related_name="owner")
...
class ParcelsRc(models.Model):
    ...
    propertysituationid = models.ForeignKey(Parcels, db_column='propertysituationid', on_delete=models.CASCADE, related_name="rc")
    order = models.IntegerField(blank=True, null=True)
